...
function calcular() {
    ...
    if (vetorX.length < 3) {
        ...
        document.getElementById("dados").innerHTML += "<p class='texto'>Domínio = [" + vetorX[0] + ";" + vetorX[vetorX.length - 1] +"]<br><br>Coeficiente de determinação (r<sup>2</sup>) = " + (r2 *100).toFixed(2) + "%</p>";
